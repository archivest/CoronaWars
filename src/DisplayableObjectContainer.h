...
// E.g. card game uses it to contain tokens, so that tokens just react to notifications without needing to know whether they are on a container or on the background of the screen.
