...
It needs to be drawn to the BACKGROUND, and any changes need to be drawn to both background and foreground.
...
Use:
Tell constructor how big each tile is.
SetSize() to say how big the array of tiles is.
...
UpdateTile() if a tile needs to change, to change the value of a tile in the array AND force a redraw to the background and screen as well.
*/
class TileManager
{
public:
