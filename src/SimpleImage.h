...
public:
    ...
    I had some problems making this work on some systems but it may be useful to you - as long as it works.
    ...
    */
    ...
    A coordinateMapping function to work out how to find the position in the image.
    */
